        ...
        <t-dropdown :options="options" @click="clickHandler">
          ...
          <template #content>
            <div class="fc ac" style="gap: 6px">
              <t-button variant="outline" @click="uploadFn">{{ $t("workbench.production.editImage.assetImage") }}</t-button>
              <t-button variant="outline" @click="getStoryboardImage">{{ $t("workbench.production.editImage.storyboardImage") }}</t-button>
            </div>
          </template>
        </t-dropdown>
